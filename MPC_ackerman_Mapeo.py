...
class AckermannMPC(Node):
    def __init__(self):
        ...
        self.pub_vel_norm = self.create_publisher(Float32, "/r1/vel_normalized", 10)
    ...
    def control_loop(self):
        ...
        #Mapeo de [-1,1] se publica en un topico
        v_norm = 2.0 * (self.v_ref / self.v_max) - 1.0
        msg_vel = Float32()
        msg_vel.data = float(v_norm)
        self.pub_vel_norm.publish(msg_vel)
